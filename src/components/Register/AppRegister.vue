		...
		<div class="row card register-card" id="login-card">
			...
			<div class="col-md-6 mb-2">
				...
				<input type="text" id="first-name-input" class="form-control"
					:class="{ 'invalid-element': errors.firstName.length }" v-model="firstName">
			...
			<div class="col-md-6 mb-2">
				...
				<input type="text" id="last-name-input" class="form-control "
					:class="{ 'invalid-element': errors.lastName.length }" v-model="lastName">
			...
			<div class="col-md-12 mb-2">
				...
				<input type="text" id="home-address-input" class="form-control "
					:class="{ 'invalid-element': errors.homeAddress.length }" v-model="homeAddress">
			...
			<div id="select-container" class="col-md-12 mb-2">
				...
				<Multiselect id="specializations-input" :class="{ 'invalid-element': errors.specializations.length }"
			...
			<div class="col-md-12 mb-3">
				...
				<input type="text" id="email-input" class="form-control "
					:class="{ 'invalid-element': errors.email.length }" v-model="email">
			...
			<div class="col-md-12 mb-2">
				...
				<input type="text" id="password-input" class="form-control "
					:class="{ 'invalid-element': errors.password.length }" v-model="password">
			...
			<div class="col-md-12 mb-2">
				...
				<input type="text" id="password-confirmation-input" class="form-control"
					:class="{ 'invalid-element': errors.passwordConfirmation.length }" v-model="passwordConfirmation">
